...
#       [app]
#       title = Blade of Darkness # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Blade of Darkness
#          package.name = bladeofdarkness # This is all part of the title.
#
